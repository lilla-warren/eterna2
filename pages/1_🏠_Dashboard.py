...
with col2:
    ...
    <div class="user-card">
        ...
        <div style="display: flex; justify-content: space-between; margin: 0.8rem 0; padding: 0.5rem; background: rgba(255,255,255,0.1); border-radius: 8px;">
            ...
            <span style="font-weight: bold; color: #22C55E;">AED {st.session_state.user_profile['bill_target']}</span>
        </div>
    ...
    for title, description, savings, priority in recommendations[:5]:
    ...
    if st.button("📊 Export Data", use_container_width=True):
        ...
        user_data = {
            ...
            'summary': {
                ...
                'monthly_savings_potential': sum([120, 85, 65, 45, 75, 35]),
